...
exit_mod=1
declare -A REPL_var=( ['mode']="" ['OUTPUTFILE']="/dev/null" ['output_dump']="html" ['wordlist_dir']="$REPL_script_path/Sources/SecLists-master/Discovery/Web-Content/common.txt" ['wordlist_dns']="$REPL_script_path/Sources/SecLists-master/Discovery/DNS/shubs-subdomains.txt" ['threads']="100" )
